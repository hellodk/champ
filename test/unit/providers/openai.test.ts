/**
 * TDD: Tests for OpenAIProvider.
 * Validates OpenAI API wrapper with streaming, tool calls, and error handling.
 */
...
describe("OpenAIProvider", () => {
  ...
  it("should handle tool calls in options", async () => {
    const messages: LLMMessage[] = [{ role: "user", content: "Read main.ts" }];
