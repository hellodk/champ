...
var ChampPanels = (() => {
        ...
        return /* @__PURE__ */ React.createElement(
          "div",
          {
            ...
            style: [
              "padding:5px 8px",
              "cursor:pointer",
              "border-left:3px solid " + (isSelected ? "var(--vscode-focusBorder)" : "transparent"),
          ...
          /* @__PURE__ */ React.createElement("div", { style: "font-size:12px; font-family:monospace; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;" }, name),
          /* @__PURE__ */ React.createElement("div", { style: "font-size:10px; opacity:0.6; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;" }, dir),
          /* @__PURE__ */ React.createElement("div", { style: "font-size:10px; margin-top:2px; color:var(--vscode-gitDecoration-modifiedResourceForeground);" }, hunkCount, " hunk", hunkCount !== 1 ? "s" : "")
        );
      })
    );
  }
  function DiffOverlayPanel() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: "display:flex; flex:1; min-height:0; overflow:hidden;" }, /* @__PURE__ */ React.createElement(FileNavigator, { edits }), /* @__PURE__ */ React.createElement("div", { style: "flex:1; overflow-y:auto; padding:8px 12px;" }, selectedEdit && /* @__PURE__ */ React.createElement(FileSection, { key: selectedEdit.path, edit: selectedEdit })))
    );
  }
  ...
  var designTeamSignal = y3(null);
  var activePanelModeSignal = y3("live");
    ...
    if (msg.type === "teamBuilderLoad") {
      ...
      if (m4.team) {
        designTeamSignal.value = {
          name: m4.team.name,
          agents: m4.team.agents.map((a4) => ({
            id: a4.id,
            name: a4.name,
            dependsOn: a4.dependsOn ?? []
          }))
        };
  ...
  function AgentGraphPanel() {
    const hasLive = isVisibleSignal2.value;
    const hasDesign = designTeamSignal.value !== null;
    if (!hasLive && !hasDesign) return null;
    const panelMode = hasLive && !hasDesign ? "live" : !hasLive && hasDesign ? "design" : activePanelModeSignal.value;
    ...
    if (panelMode === "design") {
      ...
      const dependsOnMap2 = new Map(
        dt.agents.map((a4) => [a4.id, a4.dependsOn])
      );
      const fakeAgents = dt.agents.map((a4) => ({
        id: a4.id,
        name: a4.name,
        status: "pending",
        output: "",
      ...
      const positions2 = computeLayout(fakeAgents, dependsOnMap2);
      let maxX2 = 0;
      let maxY2 = 0;
      for (const { x: x3, y: y4 } of positions2.values()) {
        if (x3 + NODE_WIDTH / 2 + PADDING > maxX2)
          maxX2 = x3 + NODE_WIDTH / 2 + PADDING;
        if (y4 + NODE_HEIGHT / 2 + PADDING > maxY2)
          maxY2 = y4 + NODE_HEIGHT / 2 + PADDING;
      }
      return /* @__PURE__ */ React.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("div", { style: "display:flex; gap:4px; align-items:center;" }, hasLive && /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: () => {
            ...
            "Live"
          ), hasDesign && /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: () => {
                activePanelModeSignal.value = "design";
            ...
            "Design"
          ), /* @__PURE__ */ React.createElement("span", { style: "font-size:12px; font-weight:600; margin-left:4px;" }, dt.name)),
          /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: handleClose,
        ...
        /* @__PURE__ */ React.createElement("div", { style: "overflow:auto; max-height:300px;" }, /* @__PURE__ */ React.createElement(
          "svg",
          {
            width: Math.max(maxX2, 200),
            height: Math.max(maxY2, 120),
            xmlns: "http://www.w3.org/2000/svg"
          },
          fakeAgents.map(
            (agent) => (dependsOnMap2.get(agent.id) ?? []).map((depId) => {
              const fromPos = positions2.get(depId);
              const toPos = positions2.get(agent.id);
          ...
          fakeAgents.map((agent) => {
            const pos = positions2.get(agent.id);
            if (!pos) return null;
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: "display:flex; gap:4px; align-items:center;" }, hasDesign && /* @__PURE__ */ React.createElement(
          "button",
          {
            onClick: () => {
              activePanelModeSignal.value = "design";
      ...
      /* @__PURE__ */ React.createElement("div", { style: "display:flex;border-bottom:1px solid var(--vscode-panel-border);background:var(--vscode-sideBarSectionHeader-background);" }, ["graph", "timeline"].map((tab) => /* @__PURE__ */ React.createElement(
        "button",
        {
          key: tab,
          onClick: () => {
      ...
      agents: [
        {
          ...
          systemPrompt: "You are a senior engineer. Produce a numbered implementation plan only. No code.",
          dependsOn: [],
          condition: "",
          tools: [],
          model: "",
        ...
        },
        {
          ...
          systemPrompt: "You are an expert programmer. Follow the plan in {{planner}} exactly. Write production-quality code.",
          dependsOn: ["planner"],
          condition: "",
        ...
        },
        {
          ...
          systemPrompt: "You are a meticulous code reviewer. Review the files changed by {{coder}} and list any issues.",
          dependsOn: ["coder"],
          condition: "",
      ...
      agents: [
        {
          ...
          systemPrompt: "You are a research assistant. Gather all relevant information for the user request.",
          dependsOn: [],
          condition: "",
        ...
        },
        {
          ...
          systemPrompt: "Using the research in {{researcher}}, write a complete first draft.",
      ...
      agents: [
        {
          ...
          systemPrompt: "You are a code auditor. Find every bug, security issue, and code smell. Output a JSON array of issues.",
          dependsOn: [],
          condition: "",
        ...
        },
        {
          ...
          systemPrompt: "Verify that every issue in {{auditor}} has been fixed by {{fixer}}.",
          dependsOn: ["fixer"],
          condition: "",
          tools: ["read_file", "grep_search"],
          model: "",
    ...
    },
    {
      ...
      agents: [
        ...
        },
        {
          ...
          systemPrompt: "Combine {{analyst-a}} and {{analyst-b}} into a prioritised action list.",
      ...
      agents: [
        {
          ...
          systemPrompt: "You are a capable AI agent. Complete the user's request.",
          dependsOn: [],
          condition: "",
  ...
  var teamNameSignal = y3("My Team");
  var teamDescSignal = y3("A new agent team");
  var agentsSignal = y3([]);
  var positionsSignal = y3(/* @__PURE__ */ new Map());
  var selectedIdSignal = y3(null);
  var showGallerySignal = y3(false);
  var saveAckSignal = y3(null);
  var existingNamesSignal = y3([]);
  var dragging = null;
  var edgeDraw = null;
  function getVsCode4() {
    if (typeof window.vscode !== "undefined") {
  ...
  function computeInitialPositions(agents) {
    ...
    layers.forEach((layer, li) => {
      const y4 = PAD + li * (NODE_H + V_GAP2) + NODE_H / 2;
      layer.forEach((id, ci) => {
        const x3 = PAD + ci * (NODE_W + H_GAP2) + NODE_W / 2;
        pos.set(id, { x: x3, y: y4 });
      });
    });
    return pos;
  }
  function hasCycle(agents) {
    ...
    for (const a4 of agents) {
      for (const dep of a4.dependsOn) {
        adj.get(dep)?.push(a4.id);
        inDeg.set(a4.id, (inDeg.get(a4.id) ?? 0) + 1);
      }
    }
    const q2 = [...inDeg.entries()].filter(([, d5]) => d5 === 0).map(([id]) => id);
    let processed = 0;
    while (q2.length > 0) {
      const n3 = q2.shift();
      processed++;
      for (const nb of adj.get(n3) ?? []) {
  ...
  window.addEventListener("message", (e4) => {
    ...
    if (msg.type === "teamBuilderLoad") {
      const m4 = msg;
      existingNamesSignal.value = m4.existingNames;
      if (m4.team) {
        teamNameSignal.value = m4.team.name;
        teamDescSignal.value = m4.team.description;
        agentsSignal.value = m4.team.agents.map((a4) => ({
          id: a4.id,
          name: a4.name,
          role: a4.role,
          systemPrompt: a4.systemPrompt,
          dependsOn: a4.dependsOn ?? [],
          condition: a4.condition ?? "",
          tools: a4.tools ?? [],
          model: a4.model ?? "",
          maxTokens: a4.maxTokens ?? 4096,
          outputKey: a4.outputKey ?? a4.id,
          outputFormat: a4.outputFormat ?? "text",
          selfCritique: a4.selfCritique ?? false,
          subscribes: a4.subscribes ?? []
        }));
        positionsSignal.value = computeInitialPositions(agentsSignal.value);
      }
    } else if (msg.type === "teamBuilderSaveAck") {
      const m4 = msg;
      saveAckSignal.value = `Saved to ${m4.savedPath}`;
      setTimeout(() => {
        saveAckSignal.value = null;
      }, 3e3);
    }
  });
  function NodeCard({ agent }) {
    ...
    function onPointerDown(e4) {
      if (e4.shiftKey) {
        edgeDraw = { fromId: agent.id, curX: e4.clientX, curY: e4.clientY };
    ...
    function onPointerMove(e4) {
      if (dragging && dragging.id === agent.id) {
        const dx = e4.clientX - dragging.startX;
        const dy = e4.clientY - dragging.startY;
      ...
      if (edgeDraw && edgeDraw.fromId === agent.id) {
        edgeDraw.curX = e4.clientX;
        edgeDraw.curY = e4.clientY;
      }
    }
    function onPointerUp(_e) {
      ...
      if (edgeDraw && edgeDraw.fromId !== agent.id) {
        ...
        const updated = agentsSignal.value.map(
          (a4) => a4.id === agent.id && !a4.dependsOn.includes(fromId) ? { ...a4, dependsOn: [...a4.dependsOn, fromId] } : a4
        );
        if (!hasCycle(updated)) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: "font-size:12px;font-weight:600;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width:90%;text-align:center;" }, agent.name.length > 18 ? agent.name.slice(0, 16) + "\u2026" : agent.name),
      /* @__PURE__ */ React.createElement("div", { style: "font-size:10px;color:var(--vscode-descriptionForeground);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width:90%;text-align:center;" }, agent.role.length > 22 ? agent.role.slice(0, 20) + "\u2026" : agent.role)
    );
  }
  function EdgesSvg() {
    ...
    let maxY = 300;
    for (const { x: x3, y: y4 } of positions.values()) {
      if (x3 + NODE_W / 2 + PAD > maxX) maxX = x3 + NODE_W / 2 + PAD;
      if (y4 + NODE_H / 2 + PAD > maxY) maxY = y4 + NODE_H / 2 + PAD;
    }
    const paths = [];
  ...
  function AgentSidebar() {
    ...
    if (!selectedId) {
      return /* @__PURE__ */ React.createElement("div", { style: "padding:16px;color:var(--vscode-descriptionForeground);font-size:12px;" }, "Click a node to edit it. Shift+drag from one node to another to add a dependency.");
    }
    const agent = agentsSignal.value.find((a4) => a4.id === selectedId);
    if (!agent) return null;
    function update(field, value) {
      agentsSignal.value = agentsSignal.value.map(
        (a4) => a4.id === selectedId ? { ...a4, [field]: value } : a4
      );
    }
    function removeDepOn(depId) {
      update(
        "dependsOn",
        agent.dependsOn.filter((d5) => d5 !== depId)
      );
    }
    function deleteAgent() {
      agentsSignal.value = agentsSignal.value.filter((a4) => a4.id !== selectedId).map((a4) => ({
        ...a4,
        dependsOn: a4.dependsOn.filter((d5) => d5 !== selectedId)
      }));
      const newPos = new Map(positionsSignal.value);
    ...
    return /* @__PURE__ */ React.createElement("div", { style: "padding:12px;overflow-y:auto;height:100%;box-sizing:border-box;" }, /* @__PURE__ */ React.createElement("div", { style: "font-size:12px;font-weight:700;margin-bottom:10px;" }, "Edit Agent"), /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "ID (immutable)"), /* @__PURE__ */ React.createElement("div", { style: "font-size:12px;font-family:monospace;background:var(--vscode-textCodeBlock-background);padding:3px 6px;border-radius:3px;margin-bottom:8px;" }, agent.id), /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Name"), /* @__PURE__ */ React.createElement(
      "input",
      {
        style: inputStyle,
        value: agent.name,
        onInput: (e4) => update("name", e4.target.value)
      }
    ), /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Role"), /* @__PURE__ */ React.createElement(
      "input",
      {
        style: inputStyle,
        value: agent.role,
        onInput: (e4) => update("role", e4.target.value)
      }
    ), /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "System Prompt"), /* @__PURE__ */ React.createElement(
      "textarea",
      {
        style: `${inputStyle}height:100px;resize:vertical;font-family:var(--vscode-editor-font-family,monospace);`,
        value: agent.systemPrompt,
        onInput: (e4) => update("systemPrompt", e4.target.value)
      }
    ), /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Model (blank = team default)"), /* @__PURE__ */ React.createElement(
      "input",
      {
        style: inputStyle,
        value: agent.model,
        onInput: (e4) => update("model", e4.target.value)
      }
    ), /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Output Format"), /* @__PURE__ */ React.createElement(
      "select",
      {
        style: inputStyle,
      ...
      /* @__PURE__ */ React.createElement("option", { value: "text" }, "text"),
      /* @__PURE__ */ React.createElement("option", { value: "json" }, "json"),
      /* @__PURE__ */ React.createElement("option", { value: "files" }, "files")
    ), /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Max Tokens"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        style: inputStyle,
        value: agent.maxTokens,
        onInput: (e4) => update("maxTokens", Number(e4.target.value))
      }
    ), /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Self-Critique"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "checkbox",
        checked: agent.selfCritique,
        onChange: (e4) => update("selfCritique", e4.target.checked),
        style: "margin-bottom:8px;"
      }
    ), agent.dependsOn.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Depends On"), agent.dependsOn.map((depId) => /* @__PURE__ */ React.createElement(
      "div",
      {
        key: depId,
        style: "display:flex;align-items:center;gap:6px;margin-bottom:4px;"
      },
      /* @__PURE__ */ React.createElement("span", { style: "font-size:11px;font-family:monospace;background:var(--vscode-textCodeBlock-background);padding:2px 5px;border-radius:3px;" }, depId),
      /* @__PURE__ */ React.createElement(
        "button",
        {
  ...
  function TemplateGallery() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: "font-size:14px;font-weight:700;margin-bottom:14px;" }, "Template Gallery"),
        BUILT_IN_TEMPLATES.map((tpl) => /* @__PURE__ */ React.createElement(
          "div",
          {
            key: tpl.label,
            ...
            onMouseEnter: (e4) => {
              e4.currentTarget.style.background = "var(--vscode-list-hoverBackground)";
            },
            onMouseLeave: (e4) => {
              e4.currentTarget.style.background = "";
            }
          },
          /* @__PURE__ */ React.createElement("div", { style: "font-size:12px;font-weight:600;" }, tpl.label),
          /* @__PURE__ */ React.createElement("div", { style: "font-size:11px;color:var(--vscode-descriptionForeground);margin-top:2px;" }, tpl.description),
          /* @__PURE__ */ React.createElement("div", { style: "font-size:10px;color:var(--vscode-descriptionForeground);margin-top:4px;opacity:.7;" }, tpl.agents.map((a4) => a4.name).join(" \u2192 "))
        )),
        /* @__PURE__ */ React.createElement(
          "button",
          {
  ...
  function TeamBuilderPanel() {
    ...
    function addAgent() {
      ...
      const newPos = new Map(positionsSignal.value);
      const x3 = PAD + agentsSignal.value.length * (NODE_W + H_GAP2) + NODE_W / 2;
      const y4 = PAD + NODE_H / 2;
      newPos.set(newId, { x: x3, y: y4 });
      positionsSignal.value = newPos;
      selectedIdSignal.value = newId;
    }
    function save() {
      getVsCode4().postMessage({
    ...
    let canvasW = 600;
    let canvasH = 400;
    for (const { x: x3, y: y4 } of positionsSignal.value.values()) {
      if (x3 + NODE_W / 2 + PAD > canvasW) canvasW = x3 + NODE_W / 2 + PAD;
      if (y4 + NODE_H / 2 + PAD > canvasH) canvasH = y4 + NODE_H / 2 + PAD;
    }
    ...
    return /* @__PURE__ */ React.createElement("div", { style: "display:flex;flex-direction:column;height:100%;overflow:hidden;" }, /* @__PURE__ */ React.createElement("div", { style: "display:flex;align-items:center;gap:8px;padding:8px 12px;border-bottom:1px solid var(--vscode-panel-border);background:var(--vscode-sideBarSectionHeader-background);flex-shrink:0;" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        style: `${inputStyle}width:180px;font-weight:600;`,
        value: teamNameSignal.value,
        onInput: (e4) => {
          teamNameSignal.value = e4.target.value;
        },
      ...
      "input",
      {
        ...
        onInput: (e4) => {
          teamDescSignal.value = e4.target.value;
        },
      ...
      "Templates"
    ), /* @__PURE__ */ React.createElement("button", { style: btnStyle, onClick: addAgent }, "+ Agent"), /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      "Save YAML"
    ), saveAckSignal.value && /* @__PURE__ */ React.createElement("span", { style: "font-size:11px;color:var(--vscode-terminal-ansiGreen);" }, saveAckSignal.value)), /* @__PURE__ */ React.createElement("div", { style: "display:flex;flex:1;overflow:hidden;" }, /* @__PURE__ */ React.createElement(
      "div",
      {
        ref: _canvasRef,
        style: "flex:1;overflow:auto;position:relative;",
        onClick: (e4) => {
          if (e4.target.closest("[data-node]") === null) {
            selectedIdSignal.value = null;
          }
        }
      },
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(EdgesSvg, null),
        agentsSignal.value.map((agent) => /* @__PURE__ */ React.createElement("div", { key: agent.id, "data-node": "true" }, /* @__PURE__ */ React.createElement(NodeCard, { agent }))),
        agentsSignal.value.length === 0 && /* @__PURE__ */ React.createElement("div", { style: "position:absolute;inset:0;display:flex;align-items:center;justify-content:center;color:var(--vscode-descriptionForeground);font-size:13px;pointer-events:none;" }, 'Click "+ Agent" or "Templates" to get started')
      )
    ), /* @__PURE__ */ React.createElement("div", { style: "width:280px;flex-shrink:0;border-left:1px solid var(--vscode-panel-border);overflow:hidden;display:flex;flex-direction:column;" }, /* @__PURE__ */ React.createElement(AgentSidebar, null))), showGallerySignal.value && /* @__PURE__ */ React.createElement(TemplateGallery, null));
  }

  // webview-ui/src/components/RulesEditorPanel.tsx
  var rulesSignal = y3([]);
  var editingRuleSignal = y3(null);
  var isNewRuleSignal = y3(false);
  function getVsCode5() {
    if (typeof window.vscode !== "undefined") {
      return window.vscode;
    }
  ...
  function RuleForm() {
    ...
    function save() {
      ...
      getVsCode5().postMessage({ type: "ruleAdd", rule: editingRuleSignal.value });
    }
    function cancel() {
      editingRuleSignal.value = null;
      isNewRuleSignal.value = false;
    ...
    const inputStyle = "width:100%;box-sizing:border-box;background:var(--vscode-input-background);color:var(--vscode-input-foreground);border:1px solid var(--vscode-input-border);border-radius:3px;padding:4px 6px;font-size:12px;margin-bottom:8px;";
    const labelStyle = "font-size:11px;color:var(--vscode-descriptionForeground);margin-bottom:2px;display:block;";
    return /* @__PURE__ */ React.createElement("div", { style: "padding:14px;border-left:1px solid var(--vscode-panel-border);width:320px;flex-shrink:0;overflow-y:auto;box-sizing:border-box;" }, /* @__PURE__ */ React.createElement("div", { style: "font-size:12px;font-weight:700;margin-bottom:12px;" }, isNew ? "New Rule" : `Edit: ${rule.name}`), isNew && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Name (filename without .md)"), /* @__PURE__ */ React.createElement(
      "input",
      {
        style: inputStyle,
        value: rule.name,
    ...
    )), /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Type"), /* @__PURE__ */ React.createElement(
      "select",
      {
        style: inputStyle,
        value: rule.type,
        onChange: (e4) => update("type", e4.target.value)
      },
      /* @__PURE__ */ React.createElement("option", { value: "always" }, "always \u2014 injected into every prompt"),
      /* @__PURE__ */ React.createElement("option", { value: "auto-attached" }, "auto-attached \u2014 injected when file matches glob"),
      /* @__PURE__ */ React.createElement("option", { value: "agent-requested" }, "agent-requested \u2014 fetched on demand")
    ), rule.type === "auto-attached" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Glob pattern"), /* @__PURE__ */ React.createElement(
      "input",
      {
        style: inputStyle,
        value: rule.glob ?? "",
        onInput: (e4) => update("glob", e4.target.value || void 0),
        placeholder: "e.g. **/*.ts"
      }
    )), /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Content"), /* @__PURE__ */ React.createElement(
      "textarea",
      {
        style: `${inputStyle}height:200px;resize:vertical;font-family:var(--vscode-editor-font-family,monospace);font-size:12px;`,
        value: rule.content,
        onInput: (e4) => update("content", e4.target.value),
  ...
  function RulesEditorPanel() {
    ...
    function deleteRule(name) {
      getVsCode5().postMessage({ type: "ruleDelete", name });
    }
    const rules = rulesSignal.value;
    return /* @__PURE__ */ React.createElement("div", { style: "display:flex;flex-direction:column;height:100%;overflow:hidden;" }, /* @__PURE__ */ React.createElement("div", { style: "display:flex;align-items:center;gap:8px;padding:8px 12px;border-bottom:1px solid var(--vscode-panel-border);background:var(--vscode-sideBarSectionHeader-background);flex-shrink:0;" }, /* @__PURE__ */ React.createElement("span", { style: "font-size:13px;font-weight:700;flex:1;" }, "Rules Editor"), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: openNew,
      ...
      "+ New Rule"
    )), /* @__PURE__ */ React.createElement("div", { style: "display:flex;flex:1;overflow:hidden;" }, /* @__PURE__ */ React.createElement("div", { style: "flex:1;overflow-y:auto;" }, rules.length === 0 && /* @__PURE__ */ React.createElement("div", { style: "padding:20px;color:var(--vscode-descriptionForeground);font-size:12px;" }, 'No rules yet. Create one with "+ New Rule" or add a', " ", /* @__PURE__ */ React.createElement("code", null, ".md"), " file to ", /* @__PURE__ */ React.createElement("code", null, ".champ/rules/"), "."), rules.map((rule) => /* @__PURE__ */ React.createElement(
      "div",
      {
        key: rule.name,
      ...
      /* @__PURE__ */ React.createElement("div", { style: "flex:1;min-width:0;" }, /* @__PURE__ */ React.createElement("div", { style: "display:flex;align-items:center;gap:8px;margin-bottom:3px;" }, /* @__PURE__ */ React.createElement("span", { style: "font-size:12px;font-weight:600;font-family:monospace;" }, rule.name), /* @__PURE__ */ React.createElement(RuleTypeTag, { type: rule.type }), rule.glob && /* @__PURE__ */ React.createElement("span", { style: "font-size:10px;color:var(--vscode-descriptionForeground);font-family:monospace;opacity:.7;" }, rule.glob)), /* @__PURE__ */ React.createElement("div", { style: "font-size:11px;color:var(--vscode-descriptionForeground);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;" }, rule.content.slice(0, 80), rule.content.length > 80 ? "\u2026" : "")),
      /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: (e4) => {
    ...
    ))), editingRuleSignal.value && /* @__PURE__ */ React.createElement(RuleForm, null)));
  }
  ...
  function mountTeamBuilder(container) {
    R(/* @__PURE__ */ React.createElement(TeamBuilderPanel, null), container);
  }
  function mountRulesEditor(container) {
    R(/* @__PURE__ */ React.createElement(RulesEditorPanel, null), container);
  }
